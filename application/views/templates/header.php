            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= site_url('Prodi/')?>" aria-expanded="false">
                                <span>
                        ...
                        <?php }else { 
                          ?>
                          <li class="sidebar-item">
                          <a class="sidebar-link" href="<?= site_url('Profil/')?>" aria-expanded="false">
                              <span>
                                  <i class="ti ti-layout-dashboard"></i>
                              </span>
                    ...
                    <div class="unlimited-access hide-menu bg-light-primary position-relative mb-7 mt-5 rounded">
                        <div class="d-flex">
                            ...
                            <div class="unlimited-access-img">
                                <img src="<?=base_url('assets/')?>/images/backgrounds/rocket.png" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            ...
                            <span class="mr-2 d-none d-lg-inline text-gray-600small"><?= $user['nama']; ?></span>
                            <li class="nav-item dropdown">
                              
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    
                                    <img src="<?= base_url('assets/images/profile/') . $user['gambar'];?>" alt="" width="35"
